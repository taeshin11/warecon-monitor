...
export default function ShareButtons() {
  ...
  const linkClass =
    "inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full border border-[var(--border-light)] text-[var(--text-secondary)] hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)] transition-colors";
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <a href={redditUrl} target="_blank" rel="noopener noreferrer" className={linkClass} aria-label="Share on Reddit">
      ...
      <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className={linkClass} aria-label="Share on Facebook">
